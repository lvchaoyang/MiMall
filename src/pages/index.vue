L<template>
  <div class="index">
    <div class="container">
                ...
                <ul v-for="(item, i) in menuList" :key="i">
                  <li v-for="(sub, j) in item" :key="j">
                    <a :href="sub ? '/product/' + sub.id : ''">
                      <img :src="sub ? sub.img : require('../assets/images/item-box-1.png')" alt="">
                      {{ sub ? sub.name : '小米9' }}
                    </a>
                  </li>
                </ul>
      ...
      <div class="banner">
        <a href="/product/30">
          <img v-lazy="require('../assets/images/banner-1.png')" alt="">
        </a>
      </div>
    </div>
          ...
          <div class="list-box">
            <div class="list" v-for="(arr,i) in phoneList" :key="i">
              <div class="item" v-for="(item,j) in arr" :key="j">
                <span :class="{'new-pro': j % 2 === 0, 'kill-pro': j % 2 === 1}">
                  {{ j % 2 === 0 ? '新品' : '秒杀' }}
                </span>
                <div class="item-img">
    ...
    return {
      ...
      menuList:[
        [
          {
            id: 30,
            img: require('../assets/images/item-box-1.png'),
            name: '小米CC9',
          },{
            id:31,
            img: require('../assets/images/item-box-2.png'),
            name:'小米8青春版',
          },{
            id:32,
            img: require('../assets/images/item-box-3.jpg'),
            name:'Redmi K20 Pro',
          },{
            id:33,
            img: require('../assets/images/item-box-4.jpg'),
            name:'移动4G专区',
          }
        ],
      ...
      adsList:[
        {
          id:33,
          img: require('../assets/images/ads/ads-1.png')
        },{
          id:48,
          img: require('../assets/images/ads/ads-2.jpg')
        },{
          id:45,
          img: require('../assets/images/ads/ads-3.png')
        },{
          id:47,
          img: require('../assets/images/ads/ads-4.jpg')
        }
      ],
      phoneList:[],
      showModal: false
