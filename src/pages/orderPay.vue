...
export default {
  ...
  methods:{
    getOrderDetail(){
      orderService.getOrderDetail(this.orderId).then((res)=>{
      ...
      .order-wrap{
        ...
        .item-order{
          ...
          .icon-succ{
            ...
            height: 90px;
            border-radius: 50%;
            background:url('../assets/images/icon-gou.png') #80c58a no-repeat center;
          ...
          .order-total{
            ...
            .icon-down{
              ...
              width:14px;
              height:10px;
              background:url('../assets/images/icon-down.png') no-repeat center;
