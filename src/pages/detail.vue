  ...
  <div class="detail">
      ...
      <div class="container clearfix">
        <div class="swiper">
          <swiper :options="swiperOption">
              <swiper-slide><img src="../assets/images/detail/phone-1.jpg" alt=""></swiper-slide>
              <swiper-slide><img src="../assets/images/detail/phone-2.jpg" alt=""></swiper-slide>
              <swiper-slide><img src="../assets/images/detail/phone-3.jpg" alt=""></swiper-slide>
              <swiper-slide><img src="../assets/images/detail/phone-4.jpg" alt=""></swiper-slide>
              <!-- Optional controls -->
    ...
    <div class="price-info">
      <div class="container">
        <h2>价格说明</h2>
        <div class="desc">
          <img src="../assets/images/detail/item-price.jpeg" alt="">
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async getProductInfo () {
      let data = await productService.getProductInfo(this.id)
      this.product = data;
    },
    /**
     * 加入购物车
      ...
      .content{
        ...
        .item-addr{
          ...
          .icon-loc{
            ...
            top: 27px;
            left: 34px;
            @include bgImg(20px,20px,'../assets/images/detail/icon-loc.png');
          }
          .addr{
            color:#666666;
          }
